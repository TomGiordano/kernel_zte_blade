...
--------     ----       -----------------------------                ----------------------
2011-03-22   lijing     enable flash function for camera             ZTE_CAM_LJ_20110322
2011-01-07   zt         modify CAM_IOVDD from msmp 2.8V to gp4 1.8V  ZTE_CAMERA_ZT_20110107
                        for LDO power
2011-01-05   zfj        modify max_x, max_y in struct msm_tssc_pdata ZTE_KEY_ZFJ_0105
                        for N700
2010-12-27   wly        add touch driver                             ZTE_WLY_CRDB00592894
2010-12-07   qxx        compatible of qualcomm and broadcomm bluetooth chip     ZTE_BT_QXX_20101207
2010-12-01   jia.jia    merge code for msm_camera_power_backend      ZTE_CAMERA_JIA_20100909
                        from board-joe in Eclair;
                        add support of CONFIG_SENSOR_ADAPTER
2010-10-25   qxx        modify bt power for broadcom bluetooth chip  ZTE_BT_QXX_20101025
2010-10-21   wangzy     add AT interface for N606                    ZTE_USB_WZY_101021
...
2010-09-02   li.jing    add config for MT9D113-2.0Mp-FF-Socket       ZTE_CAMERA_LIJING_20100902
2010-08-27   jia.jia    add CONFIG_SENSOR_ADAPTER for MT9T112-3.0Mp  ZTE_CAMERA_JIA_20100827
                        -AF-Socket and MT9D115-2.0Mp-FF-Socket
