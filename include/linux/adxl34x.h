...
#define ADXL34XIO				0xA2
/* IOCTLs*/
#define ADXL34X_IOCTL_INIT                   _IO(ADXL34XIO, 0x31)
#define ADXL34X_IOCTL_WRITE                  _IOW(ADXL34XIO, 0x32, char[5])
#define ADXL34X_IOCTL_READ                   _IOWR(ADXL34XIO, 0x33, char[5])
#define ADXL34X_IOCTL_READ_ACCELERATION      _IOWR(ADXL34XIO, 0x34, short[3])
#define ADXL34X_IOCTL_SET_MODE	  			 _IOW(ADXL34XIO, 0x35, short)
#define ADXL34X_IOCTL_GET_INT	 			 _IOR(ADXL34XIO, 0x36, short)
