...
/******************************************************************
*File Name: 	android.c 	                                         *
*Description:	Linux usb client driver                              *                              
********************************************************************
Geschichte:	                                                                        
When          who        what                               Tag

2010-10-25  wangzy    enable cdrom when pid is matched      wangzy_101025
2010-10-21    wangzy     add AT interface fo N606           ZTE_USB_WZY_101021
...
android_func_attr(at, ANDROID_GENERIC_AT);
