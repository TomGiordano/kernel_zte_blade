...
2011-02-26   luya    	modify some delay of bkl CTL CRDB00616898 ZTE_LCD_LUYA_20100226_001
2010-10-27   luya    	modify some delay to void tearing	 ZTE_LCD_LUYA_20101113_001	CRDB00590137
2010-10-27   luya    	disable reset for 1st time			 ZTE_LCD_LUYA_20101027_001
...
static int __init lcdc_panel_probe(struct platform_device *pdev)
{
	...
	if(pdev->id == 0) {
		...
		lcdc_v9_pdata->panel_config_gpio(1);
	 	...
	 	LcdPanleID=(u32)LCD_PANEL_V9_NT39416I;   
