...
2010-04-08   lht		backlight adjust           					ZTE_LCD_LHT_20100408_001
2010-04-07   lht		backlight level should equals to appsboot	ZTE_LCD_LHT_20100407_001
2010-01-26   luya		fix white-screen(permanent) when wakeup	ZTE_LCD_LUYA_20100126_001
2010-01-14   luya		fix white-screen when wakeup(cause:bkl on before lcd)ZTE_LCD_LUYA_20100114_001
...
static __u32 last_bl_level = 6;  //ZTE_LCD_LHT_20100407_001
   ...
   else 
   {
	   ...
	   else   //need decreasing feedback vlotage
	   {
			    ...
			    spin_unlock_irqrestore(&tps61061_lock, flags); //unlock
			     ...
			     /* at least delay 1.5us between steps */    
			    udelay(30); //ZTE_LCD_LHT_20100408_001
		        }     
	   }
   }
...
static int __init lcdc_himax_panel_init(void)
{
	...
	if (ret) 
		return ret;
	LcdPanleID=(u32)LCD_PANEL_P722_HX8352A;   //ZTE_LCD_LHT_20100611_001
