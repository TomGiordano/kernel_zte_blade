...
static long ov5642_set_wb(int8_t wb_mode)
{
    ...
    switch(wb_mode)
    {
        ...
        case CAMERA_WB_MODE_NIGHT:
        {
            ...
            rc = ov5642_i2c_write(ov5642_client->addr, 0x3010 ,0x0070, WORD_LEN);
            if (rc < 0)
            {
               return rc;
            }
...
static long ov5642_hw_ae_transfer(void)
{
    ...
    {    
        ...
        capture_exposure_gain = 20 * capture_exposure * capture_gain / 10; 
