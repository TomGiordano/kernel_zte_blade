...
extern struct ov5642_reg_t ov5642_regs;
...
struct ov5642_reg_t {
    struct ov5642_i2c_reg_conf const *prev_snap_reg_settings;
    uint16_t prev_snap_reg_settings_size;
    struct ov5642_i2c_reg_conf const *noise_reduction_reg_settings;
    ...
    uint16_t rftbl_size;
    struct ov5642_i2c_reg_conf const *snapshot2preview_tbl;
    uint16_t snapshot2preview_size;    
    struct ov5642_i2c_reg_conf const *preview2snapshot_tbl;
    uint16_t preview2snapshot_size;    
    struct ov5642_i2c_reg_conf const *autofocus_reg_settings;
