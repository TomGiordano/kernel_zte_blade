...
static int32_t mt9p111_set_antibanding(int8_t antibanding)
{
    ...
    switch (antibanding)
    {
        ...
        {
            rc = mt9p111_i2c_write(mt9p111_client->addr, 0x098E, 0x8417, WORD_LEN); 
            if (rc < 0)
            {
                return rc;
            }
            rc = mt9p111_i2c_write(mt9p111_client->addr, 0x8417, 0x01, BYTE_LEN); 
            if (rc < 0)
            {
                return rc;
            }
            rc = mt9p111_i2c_write(mt9p111_client->addr, 0xA004, 0x3C, BYTE_LEN); 
            if (rc < 0)
            {
                return rc;
            }
        ...
        case CAMERA_ANTIBANDING_SET_50HZ:
        {
            ...
            rc = mt9p111_i2c_write(mt9p111_client->addr, 0xA004, 0x32, BYTE_LEN); 
            if (rc < 0)
            {
                return rc;
            }
        ...
        case CAMERA_ANTIBANDING_SET_AUTO:
        {
            ...
            rc = mt9p111_i2c_write(mt9p111_client->addr, 0x8417, 0x02, BYTE_LEN); 
            if (rc < 0)
            {
                return rc;
            }
