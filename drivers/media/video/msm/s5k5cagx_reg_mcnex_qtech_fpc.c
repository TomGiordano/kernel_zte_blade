/*
 * drivers/media/video/msm/s5k5cagx_reg_mcnex_qtech_fpc.c
 *  
...
/* PLL Setup */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const pll_tbl[] = {
};

/* Clock Setup */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const clk_tbl[] = {
};

/* Preview and Snapshot Setup */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const prev_snap_tbl[] = {
//********************************//
////************************************/																															//
...
//============================================================ 
    ...
    {0x0F12, 0x0051, WORD_LEN, 0}, //REG_TC_IPRM_CM_Init_GpioConfig1 : 4 -  GPIO4 //20110418( Robin )
    {0x002A, 0x01E8, WORD_LEN, 0},
    {0x0F12, 0x200C, WORD_LEN, 0}, //REG_TC_IPRM_CM_Init_Mi2cBits : MSCL - GPIO1 MSDA - GPIO2 Device ID (0C)//20110418( Robin )
 ...
 */
    ...
    {0x0F12, 0x005E, WORD_LEN, 0},
    {0x0F12, 0x0068, WORD_LEN, 0},
    {0x0F12, 0x0072, WORD_LEN, 0},
    {0x0F12, 0x007C, WORD_LEN, 0},
    {0x0F12, 0x0086, WORD_LEN, 0},
    {0x0F12, 0x0090, WORD_LEN, 0},
    {0x0F12, 0x009A, WORD_LEN, 0},
    {0x0F12, 0x00A4, WORD_LEN, 0},
    {0x0F12, 0x00AE, WORD_LEN, 0},
    //modified by Robin,2011512 TEST1(STEP 18)

     /*
    {0x002A, 0x1074, WORD_LEN, 0},
    {0x0F12, 0x000B, WORD_LEN, 0},  //JK Kim, AF fine tuning
    {0x0F12, 0x001E, WORD_LEN, 0},
    {0x0F12, 0x002B, WORD_LEN, 0},
    ...
    {0x0F12, 0x008E, WORD_LEN, 0},
    {0x0F12, 0x009D, WORD_LEN, 0},
    {0x0F12, 0x00AC, WORD_LEN, 0},
     */
    //modified by Robin,2011512 TEST2(STEP 12)

/*
    {0x002A, 0x1074, WORD_LEN, 0},
    {0x0F12, 0x0020, WORD_LEN, 0},  //Robin,20110420
    {0x0F12, 0x0016, WORD_LEN, 0},
    {0x0F12, 0x0018, WORD_LEN, 0},
    {0x0F12, 0x001A, WORD_LEN, 0},
    {0x0F12, 0x001C, WORD_LEN, 0},
    {0x0F12, 0x001E, WORD_LEN, 0},
    {0x0F12, 0x0020, WORD_LEN, 0},
    {0x0F12, 0x0022, WORD_LEN, 0},
    {0x0F12, 0x0024, WORD_LEN, 0},
    {0x0F12, 0x0026, WORD_LEN, 0},
    {0x0F12, 0x0028, WORD_LEN, 0},
    {0x0F12, 0x002A, WORD_LEN, 0},
    {0x0F12, 0x002C, WORD_LEN, 0},
    {0x0F12, 0x002E, WORD_LEN, 0},
    {0x0F12, 0x0030, WORD_LEN, 0},
    {0x0F12, 0x0032, WORD_LEN, 0},
    {0x0F12, 0x0034, WORD_LEN, 0},
    {0x0F12, 0x0036, WORD_LEN, 0},
    {0x0F12, 0x0039, WORD_LEN, 0},
    ...
    {0x0F12, 0x00B3, WORD_LEN, 0},  
    *///deleted by Robin,20110512(STEP 32)
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const wb_cloudy_tbl[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const wb_daylight_tbl[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x246E, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const wb_flourescant_tbl[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x246E, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const wb_incandescent_tbl[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x246E, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const wb_auto_tbl[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x246E, WORD_LEN, 0},
    {0x0F12, 0x0001, WORD_LEN, 0},
...
/* Auto focus Setup */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const af_tbl[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},    
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0252, WORD_LEN, 0},//Af command  
    {0x0F12, 0x0003, WORD_LEN, 10},//初始化VCM镜头，使其位于原点的位置//20110420( Robin )
    {0x002A, 0x0252, WORD_LEN, 0},//Af command 
    {0x0F12, 0x0005, WORD_LEN, 0},//single AF,单步对焦
};

/* Contrast Setup */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const contrast_tbl_0[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const contrast_tbl_1[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020E, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const contrast_tbl_2[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020E, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const contrast_tbl_3[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020E, WORD_LEN, 0},
    {0x0F12, 0x0030, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const contrast_tbl_4[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020E, WORD_LEN, 0},
    {0x0F12, 0x0060, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const *contrast_tbl[] = {
    contrast_tbl_0,
    contrast_tbl_1,
    contrast_tbl_2,
    contrast_tbl_3,
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_0[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_1[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020C, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_2[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020C, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_3[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020C, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_4[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020C, WORD_LEN, 0},
    {0x0F12, 0x0020, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_5[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020C, WORD_LEN, 0},
    {0x0F12, 0x0040, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const brightness_tbl_6[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x020C, WORD_LEN, 0},
    {0x0F12, 0x0060, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const *brightness_tbl[] = {
    brightness_tbl_0,
    brightness_tbl_1,
    brightness_tbl_2,
    brightness_tbl_3,
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const saturation_tbl_0[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const saturation_tbl_1[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0210, WORD_LEN, 0},
    {0x0F12, 0xFFD0, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const saturation_tbl_2[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0210, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const saturation_tbl_3[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0210, WORD_LEN, 0},
    {0x0F12, 0x0030, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const saturation_tbl_4[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0210, WORD_LEN, 0},
    {0x0F12, 0x0060, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const *saturation_tbl[] = {
    saturation_tbl_0,
    saturation_tbl_1,
    saturation_tbl_2,
    saturation_tbl_3,
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_0[] = {//-2
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_1[] = {//-1
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0212, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_2[] = {//default 0
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0212, WORD_LEN, 0},
    {0x0F12, 0x0000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_3[] = {//+1
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0212, WORD_LEN, 0},
    {0x0F12, 0x0010, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_4[] = {//+2
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0212, WORD_LEN, 0},
    {0x0F12, 0x0020, WORD_LEN, 0},
 ...
 */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_5[] = {
  
};

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_6[] = {
 
};


static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_7[] = {

};

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_8[] = {

};    

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_9[] = {

};    

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const sharpness_tbl_10[] = {

};

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const *sharpness_tbl[] = {
    sharpness_tbl_0,
    sharpness_tbl_1,
    sharpness_tbl_2,
    sharpness_tbl_3,
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const exposure_tbl_0[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0F70, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const exposure_tbl_1[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0F70, WORD_LEN, 0},
    {0x0F12, 0x0038, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const exposure_tbl_2[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0F70, WORD_LEN, 0},
    {0x0F12, 0x003F, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const exposure_tbl_3[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0F70, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const exposure_tbl_4[] = {
    {0xFCFC, 0xD000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x0F70, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const *exposure_tbl[] = {
    exposure_tbl_0,
    exposure_tbl_1,
    exposure_tbl_2,
    exposure_tbl_3,
 ...
 */
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const lens_for_outdoor_tbl[] ={
};

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const lens_for_indoor_tbl[] ={
};

static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const iso_auto_tbl[] = {
    {0xfcfc, 0xd000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const iso_100_tbl[] = {
    {0xfcfc, 0xd000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x12B8, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const iso_200_tbl[] = {
    {0xfcfc, 0xd000, WORD_LEN, 0}, 
    {0x0028, 0x7000, WORD_LEN, 0}, 
    {0x002A, 0x12B8, WORD_LEN, 0}, 
    {0x0F12, 0x2000, WORD_LEN, 0}, 
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const iso_400_tbl[] = {
    {0xfcfc, 0xd000, WORD_LEN, 0}, 
    {0x0028, 0x7000, WORD_LEN, 0}, 
    {0x002A, 0x12B8, WORD_LEN, 0}, 
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const iso_800_tbl[] = {
    {0xfcfc, 0xd000, WORD_LEN, 0},
    {0x0028, 0x7000, WORD_LEN, 0},
    {0x002A, 0x12B8, WORD_LEN, 0},
...
static struct s5k5cagx_mcnex_qtech_i2c_reg_conf const *iso_tbl[] = {
    iso_auto_tbl,
    iso_100_tbl,
    iso_200_tbl,
    iso_400_tbl,
...
struct s5k5cagx_mcnex_qtech_base_reg_t s5k5cagx_mcnex_qtech_regs = {
    .pll_tbl                = pll_tbl,
