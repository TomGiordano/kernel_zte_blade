...
#define MT9D115_GPIO_SWITCH_CTL     107
#define MT9D115_GPIO_SWITCH_VAL     0
#elif defined(CONFIG_MACH_SAILBOAT)
#define MT9D115_GPIO_SWITCH_CTL     30
#define MT9D115_GPIO_SWITCH_VAL     0
#else
...
static int mt9d115_sensor_dev_probe(const struct msm_camera_sensor_info *pinfo)
{
    ...
    /*
      * Sensor Clock Switch
      */
#if defined(CONFIG_MACH_R750) || defined(CONFIG_MACH_JOE) || defined(CONFIG_MACH_V9)|| defined(CONFIG_MACH_SAILBOAT)
