...
static long ov5640_hw_ae_transfer(void)
{
    ...
    {    
        ...
        */
        ...
        //CDBG("ov5640_hw_ae_transfer:capture_exposure =%x \n",capture_exposure);
        //CDBG("ov5640_hw_ae_transfer:exposure_low =%x \n",exposure_low);
        //CDBG("ov5640_hw_ae_transfer:exposure_mid =%x \n",exposure_mid);
        //CDBG("ov5640_hw_ae_transfer:exposure_high =%x \n",exposure_high);
