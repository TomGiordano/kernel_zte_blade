 ...
 * camera app startup
 *
 * Attention: "CONFIG_SENSOR_ADAPTER" should support "MT9D113_SENSOR_PROBE_INIT" only
 */
 ...
 * #define MT9D113_GPIO_SHUTDOWN_CTL   Dummy
 */
 ...
 *
 * Hard standby mode is set by register of REG_MT9D113_STANDBY_CONTROL.
 */
...
static int mt9d113_hard_reset(const struct msm_camera_sensor_info *dev)
{
    ...
    if (0 == rc)
    {
        ...
        /*
          ...
          * EXTCLKs: = MCLK (i.e., MT9D113_CAMIO_MCLK)
          */
        mdelay(10);
    ...
    switch (effect)
    {
        ...
        default:
        {
            /* add code here
                 ...
                 rc = mt9d113_i2c_write(mt9d113_client->addr, 0xXXXX, reg_addr, WORD_LEN);
                 if (rc < 0)
                 {
                    return rc;
                 }
 ...
 *
 * MT9D113_GPIO_SHUTDOWN_CTL: 0, to quit lowest-power mode, or
...
static int mt9d113_sensor_init_probe(const struct msm_camera_sensor_info *data)
{
    ...
    /*
      * Enable PLL in order to read reg of REG_MT9D113_MODEL_ID_SUB successfully
      */
    ...
    /* Read the Model Sub ID of the sensor */
    model_id = 0x0000;
    ...
    switch (cfg_data.cfgtype)
    {
        ...
        case CFG_SET_AF:
        {
            /*
               ...
               * ignore "rc"
               */
            //rc = mt9d113_set_lensshading(1);
            //rc = mt9d113_af_trigger();
            rc = 0;
        }
        break;
        ...
        case CFG_SET_LENS_SHADING:
        {
            /*
               * no code here
               */
            //rc = mt9d113_set_lensshading(cfg_data.cfg.lensshading);
            rc = 0;
        }
        break;
...
static int mt9d113_sensor_release_internal(void)
{
    ...
    /*
      * mt9d113_ctrl's memory is allocated in mt9d113_sensor_probe_init
      * during system initialization in the condition of attachment of sensor hardware
      * otherwise, there will be NULL pointer for mt9d113_ctrl->sensordata
      */
    switch_on = 1;
    rc = mt9d113_hard_standby(mt9d113_ctrl->sensordata, switch_on);
    if (rc < 0)
